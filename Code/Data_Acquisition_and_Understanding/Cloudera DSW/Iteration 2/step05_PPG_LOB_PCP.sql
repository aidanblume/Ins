...
select distinct segment, lob, ppg, ppg_name, ncqa_lob from prjrea_step5_PPG_LOB_PCP;

select distinct ncqa_lob, lob, product_name, segment from prjrea_step5_PPG_LOB_PCP
order by lob, product_name, segment
;

select * from nathalie.ref_lob
